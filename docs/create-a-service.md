 ...
 */
export interface MyApiServiceConfiguration
  extends MainTaskSizeConfiguration, ServiceConfiguration {
  /**
...
import {
  ...
  IContainerService,
} from "../constructs/ContainerPlatform";
...
export class MyApiService extends Construct implements IContainerService {
  ...
  constructor(
    scope: Construct,
    id: string,
    private props: MyApiServiceProps,
  ) {
    super(scope, id);
